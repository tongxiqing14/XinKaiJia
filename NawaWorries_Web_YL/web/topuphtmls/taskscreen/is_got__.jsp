...
xmlhttp.open("Post", is_got_url+"?item_index="+(js[0].fighter_id-1)+"&grouptype="+selectIndex+"&preScreen=is_got__", true);    /**item id per page*/
xmlhttp.send();
...
document.getElementById("div_div_msg_id").innerHTML = "请先"+fighter_name_array1[(fighter_id_temp-2)];
document.getElementById("msgDiv").style.left=120;
document.getElementById("msgDiv").style.top=90;
...
xmlhttp.open("Post", is_got_url+"?item_index="+(js[0].fighter_id-3)+"&grouptype="+selectIndex+"&preScreen=is_got__", true);    /**item id per page*/
xmlhttp.send();
xmlhttp.onreadystatechange = function () {
if (xmlhttp.readyState == 4) {
var js__$$$$ = eval(xmlhttp.responseText);
...
document.getElementById("div_div_msg_id").innerHTML = "请先"+fighter_name_array1[(fighter_id_temp-4)];
document.getElementById("msgDiv").style.left=120;
document.getElementById("msgDiv").style.top=90;
setTimeout("transitdd()",500);
}
