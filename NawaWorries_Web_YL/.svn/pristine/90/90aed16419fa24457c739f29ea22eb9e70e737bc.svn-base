...
function ajax_show_balance(){
    ...
    xmlhttp.onreadystatechange = function () {
        if (xmlhttp.readyState == 4) {
            ...
            if(js[0].balance-price_json$$.item2000[1] < 0){
                consume_step = 2;
                document.getElementById("div_div_msg1_id").innerHTML = "<br>您的当前代币余额:"+js[0].balance+"代币"+"<br>余额不足，需充值"+(price_json$$.item2000[1]-js[0].balance)+"代币";
