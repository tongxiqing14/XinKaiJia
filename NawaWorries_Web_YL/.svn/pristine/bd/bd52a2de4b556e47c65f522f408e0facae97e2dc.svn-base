...
public class DateFormatUtil {
	...
	public static String toDateFormat(Date date) {
		...
		myDate.append(date.getYear() + 1900)
			.append("-")
			.append(addZero(date.getMonth() + 1))
			.append("-")
			.append(addZero(date.getDate()));
	...
	public static String toTimeFormat(Date date) {
		...
		myDate.append(date.getYear() + 1900)
			...
			.append(addZero(date.getDate()))
			.append(" ")
			.append(addZero(date.getHours()))
			.append(":")
			.append(addZero(date.getMinutes()))
			.append(":")
			.append(addZero(date.getSeconds()));
		return myDate.toString();
	}
