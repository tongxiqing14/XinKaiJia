 ...
 */
public class StageOp {

    public static void main(String[] args){
        StageOp stageOp = new StageOp();
        System.out.println(StageOp.initialStageData());
    }
    ...
    public static String initialStageData(){
        ...
        StageBtnItem stageBtnItem00  = new StageBtnItem(3,1,3,202,230,"stage/map1/images/tab03.png",true);
        stageBtnItemList.add(stageBtnItem00);
